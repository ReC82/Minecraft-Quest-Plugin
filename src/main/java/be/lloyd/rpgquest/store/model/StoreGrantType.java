package be.lloyd.rpgquest.store.model;
...
public enum StoreGrantType {
    /** Taille de backpack (Small/Medium/Large) — {@link be.lloyd.rpgquest.backpack.model.BackpackSize}. */
    BACKPACK_SIZE,
    /** Avantage générique via {@link be.lloyd.rpgquest.entitlement.EntitlementService} (VIP, cosmétique...). */
    ENTITLEMENT
}
